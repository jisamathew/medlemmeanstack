...
function getUsers(){
 ...
 User.getUsers().then(function(data){
        if(data.data.success) {
            ...
            if(data.data.permission === 'organization' ){
                ...
                else if(data.data.permission === 'member')
                {
                    app.editAccess = true;
                }
            }
         ...
         if(valid){
            ...
            User.editUser(userObject).then(function(data){
                if(data.data.success){
                    app.successMsg = data.data.message;
                    $timeout(function(){
                        app.nameForm.email.$setPristine();
                        app.nameForm.email.$setUntouched();
                        app.successMsg=false;
                        app.disabled=false;
